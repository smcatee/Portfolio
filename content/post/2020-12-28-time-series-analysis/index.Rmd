...
categories: []
tags: []
Description: 'Time series analysis of temperature data'
Tags: []
Categories: []
DisableComments: yes
output:
...
paste(TFNtxt, "Manhattan",
      paste(fivenum(allTemps$Temperature[allTemps$Location == "Manhattan"]),collapse=" "))
```
</br>
