...
These are the top percentiles of cosines for each group. I selected the top 97.5%-ile for Diabetes, 75% for Asthma, and 98% for HIV to get a similar length outputs.
...
hiv$journal_x[hiv$cosine_similarity > 
                quantile(ingroup_hiv_cossim, probs = 0.98) &
...
pvals <- rbind(rbind(diabetes_asthma_diff$criticalPVal, diabetes_hiv_diff$criticalPVal),
      asthma_hiv_diff$criticalPVal)
colnames(pvals) <- diabetes_asthma_diff$quantile
pvals
```
