...
https://about.gitlab.com/stages-devops-lifecycle/continuous-integration/ `# GitLab website/portfolio`

https://pages.github.com/

https://www.freecodecamp.org/news/hugo-vs-jekyll-battle-of-static-site-generator-themes/ `# Jekyll, similar to Hugo`

https://hexo.io/ `# Hexo, similar to Hugo`
...
https://gohugo.io/ `# The Hugo program website`

https://cran.r-project.org/web/packages/rmarkdown/rmarkdown.pdf `# Download R Markdown`

https://pkgs.rstudio.com/rmarkdown/articles/rmarkdown.html#user-guide-1 `# User guide R Markdown`

https://pkgs.rstudio.com/rmarkdown/articles/rmarkdown.html#cheatsheets-1 `# Cheatsheet R Markdown`

https://rmarkdown.rstudio.com/lesson-1.html `# More R Markdown resources`

https://bookdown.org/yihui/blogdown/workflow.html `# Recommended website build workflow`

https://git-scm.com/book/en/v2/Getting-Started-About-Version-Control#ch01-getting-started `# Git basics`

https://yihui.org/  `# The primary blogdown & knitr author`

https://drive.google.com/drive/folders/1Or_AFogbpRCHf3eSlvMd2SAVy1dXTFEz?usp=sharing `# Drive folder with this tutorial as .pdf and .Rmd`
