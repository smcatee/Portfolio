...
Your default domain name will be <username.netlify.app>. There are options [to purchase a custom domain name from Netlify](https://docs.netlify.com/domains-https/netlify-dns/) or to [use your custom domain name](https://docs.netlify.com/domains-https/custom-domains/).
...
[i](https://davidventuri.com/portfolio)
[n](http://hadley.nz/)
[s](https://restofworld.org/)
[p](https://www.mkbergman.com/the-blogasbrd/)
[i](http://varianceexplained.org/)
[r](https://simplystatistics.org/)
[e](https://citizenlab.ca/)
[d](https://thepeacewireproject.com/)
.
