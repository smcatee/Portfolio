...
This shows TF-IDF overlayed by IDF upper and lower quantiles. Upper quantile IDF terms (terms appearing in only one `quality`) are shifted above an TF-IDF score of 0.005. Terms that appear in 2 or 3 `quality` groups have lower TF-IDF scores.
